...
import { Plus, Trash2, ArrowUp, ArrowDown, Save, Loader2, Copy, Play, ArrowRight } from 'lucide-react';
...
const CreateQuiz = () => {
  ...
  const [inputMethod, setInputMethod] = useState<'text' | 'file' | 'video'>('text');
      ...
      <div className="mb-8 rounded-lg border bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="space-y-2">
            ...
            {quizData.has_timer && (
              <div className="ml-6">
                <label htmlFor="timerSeconds" className="block text-sm font-medium text-gray-700">
          ...
          >
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Add content to generate questions automatically, or add questions manually
              </p>
      ...
      <div className="mb-8 rounded-lg border bg-white p-6 shadow-sm">
        ...
        {quizData.questions.length === 0 ? (
          <div className="flex h-32 flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-4 text-center">
            <p className="text-sm text-gray-600">
              No questions yet. Generate questions from content or add them manually.
            </p>
          </div>
        ) : (
